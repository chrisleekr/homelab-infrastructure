...
sequenceDiagram
    ...
    TS->>Tailscale: Advertise routes from tailscale_advertise_routes
...
| `tailscale_auth_key` | Tailscale auth key (from admin console) | required, sensitive, no default |
| `tailscale_advertise_routes` | Routes to advertise (CIDR, comma-separated) | `192.86.0.0/24` |
